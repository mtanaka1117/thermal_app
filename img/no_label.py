...
for i in file_list:
    try:
        if '_V' in i and '_T' in file_list.peek():
            ...
            # img_th_v = cv2.adaptiveThreshold(diff_v,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY,333,2)
            ...
            for contour in contours:
                ...
                if area > 300:
                    ...
                    cv2.rectangle(img_v_color, (x, y), (x + w, y + h), (255, 0, 0), 2)
...
# b_thermal_path = r"C:\Users\tnkmo\Downloads\20240112_items2-selected\yolo1\20240112_1418\20240112_141818924_T.jpg"
# a_thermal_path = r"C:\Users\tnkmo\Downloads\20240112_items2-selected\yolo1\20240112_1418\20240112_141825090_T.jpg"

# b_visual_path = r"C:\Users\tnkmo\Downloads\20240112_items2-selected\yolo1\20240112_1418\20240112_141818924_V.jpg"
# a_visual_path = r"C:\Users\tnkmo\Downloads\20240112_items2-selected\yolo1\20240112_1418\20240112_141825117_V.jpg"

# b_visual = cv2.imread(b_visual_path)
# a_visual = cv2.imread(a_visual_path)

# diff = cv2.absdiff(a_visual, b_visual)
# gray = cv2.cvtColor(diff, cv2.COLOR_BGR2GRAY)
# _, thres = cv2.threshold(gray, 12, 255, cv2.THRESH_BINARY)
...
#         if area > 100:
#             x, y, w, h = cv2.boundingRect(contour)
#             cv2.rectangle(a_visual, (x, y), (x + w, y + h), (255, 0, 0), 2)

# cv2.imshow('test', a_visual)
# cv2.waitKey()
