...
ax[0,0].axhline(y=book_one_sigma, xmin=0.065, xmax=0.98, color="blue", label="+1σ")
ax[0,0].axhline(y=book_two_sigma, xmin=0.065, xmax=0.98, color="green", label="+2σ")
ax[0,0].set_title('book', size=16)

ax[0,1].plot(paper_pd.rolling(10).mean(), label="paper", color="red")
ax[0,1].axhline(y=paper_one_sigma, xmin=0.065, xmax=0.98, color="blue", label="+1σ")
ax[0,1].axhline(y=paper_two_sigma, xmin=0.065, xmax=0.98, color="green", label="+2σ")
ax[0,1].set_title('paper', size=16)

ax[1,0].plot(cup_pd.rolling(10).mean(), label="stainless", color="red")
ax[1,0].axhline(y=cup_one_sigma, xmin=0.065, xmax=0.98, color="blue", label="+1σ")
ax[1,0].axhline(y=cup_two_sigma, xmin=0.065, xmax=0.98, color="green", label="+2σ")
ax[1,0].set_title('stainless', size=16)

ax[1,1].plot(plastic_pd.rolling(10).mean(), label="plastic", color="red")
ax[1,1].axhline(y=plastic_one_sigma, xmin=0.065, xmax=0.98, color="blue", label="+1σ")
ax[1,1].axhline(y=plastic_two_sigma, xmin=0.065, xmax=0.98, color="green", label="+2σ")
