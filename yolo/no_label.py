...
# path = '/home/srv-admin/images/items1/*/*.jpg'
path = '/home/srv-admin/images/yolo+1/*/*jpg'
...
for i in file_list:
    try:
        if '_V' in i and '_T' in file_list.peek():
            ...
            pred = model.predict(img_v_color, classes=[1, 25, 26, 28, 39, 41, 64, 65, 67, 73, 74, 76])
            frame = pred[0].plot()
            ...
            contours2, _ = cv2.findContours(dilate, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
